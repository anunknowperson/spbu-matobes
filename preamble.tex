...
\usepackage{relsize} %to size math symbols
...
\declaretheorem[style=thmbluebox, numbered=no, name=Алгоритм]{algoritm}
...
\declaretheorem[style=thmblueline, numbered=no, name=Следствие]{impl}
